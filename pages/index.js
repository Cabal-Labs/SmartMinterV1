      ...
      <div className={styles['Mobile']}>
        <div className={styles['mobile-msg']}>
          ...
          <div className={styles['images']}>
            <a href='https://twitter.com/CabalLabs' target="_blank" rel="noopener noreferrer" ><img src="/Assets/twitter.png" alt="mobile"/></a>
           <a href='https://discord.gg/qJ3FBSQQ8T' target="_blank" rel="noopener noreferrer" ><img src="/Assets/discord.png" alt="mobile"/></a>
           <a href='https://www.youtube.com/channel/UC0KhSOQYRqnp0Bo8Ew0Kd3g' target="_blank" rel="noopener noreferrer" ><img src="/Assets/youtube.png" alt="mobile"/></a>
            <a href='https://www.tiktok.com/@caballabs' target="_blank" rel="noopener noreferrer"><img src="/Assets/tik-tok.png" alt="mobile"/></a>
          </div>
        </div>
